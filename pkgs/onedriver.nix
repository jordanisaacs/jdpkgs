...
let
  ...
  onedriverWrapper = runCommand "onedriverWrapper"
    {
    ...
    (
      ''
        ...
        makeWrapper ${program}/bin/onedriver $out/bin/onedriverWrapper --set GIO_MODULE_DIR ${glib-networking}/lib/gio/modules
      ''
    );
in
onedriverWrapper
